...
if CLIENT then
	...
	killicon.Add(  "clt_glck18_cda",		"vgui/kill/clt_glck18", icol  )
	killicon.Add(  "clt_glck18_fde",		"vgui/kill/clt_glck18", icol  )
...
sound.Add({
	...
	volume = 		1.0,
	sound = 			"weapons/clt_glck18/glock18-1.wav"
})

sound.Add({
	name = 			"Weapon_glkcl.Sliderelease",
	channel = 		CHAN_ITEM,
	volume = 		1.0,
	sound = 			"weapons/clt_glck18/glock_sliderelease.wav"
})

sound.Add({
	name = 			"Weapon_glkcl.Clipout",
	channel = 		CHAN_ITEM,
	volume = 		1.0,
	sound = 			"weapons/clt_glck18/glock_clipout.wav"
})

sound.Add({
	name = 			"Weapon_glkcl.Clipin",
	channel = 		CHAN_ITEM,
	volume = 		1.0,
	sound = 			"weapons/clt_glck18/glock_clipin.wav"
})

sound.Add({
	name = 			"Weapon_glkcl.Slideback",
	channel = 		CHAN_ITEM,
	volume = 		1.0,
	sound = 			"weapons/clt_glck18/glock_slideback.wav"
})
