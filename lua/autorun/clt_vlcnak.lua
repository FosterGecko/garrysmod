...
if CLIENT then
	...
	killicon.Add(  "clt_akvlcn",		"vgui/kill/clt_akvlcn", icol  )
...
sound.Add({
	...
	volume = 		1.0,
	sound = 			"weapons/clt_vlcnak/akvlcn-1.wav"
})

sound.Add({
	name = 			"Weapon_VLAK.Clipout",
	channel = 		CHAN_ITEM,
	volume = 		1.0,
	sound = 			"weapons/clt_vlcnak/akvlcn_clipout.wav"
})

sound.Add({
	name = 			"Weapon_VLAK.BoltPull",
	channel = 		CHAN_ITEM,
	volume = 		1.0,
	sound = 			"weapons/clt_vlcnak/akvlcn_boltpull.wav"
})

sound.Add({
	name = 			"Weapon_VLAK.Clipin",
	channel = 		CHAN_ITEM,
	volume = 		1.0,
	sound = 			"weapons/clt_vlcnak/akvlcn_clipin.wav"
})
