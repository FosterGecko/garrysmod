...
SWEP.ViewModel				= "models/weapons/v_glck18cdaclt.mdl"	
...
SWEP.WElements = {
	["clt_glck18_wrld"] = { type = "Model", model = "models/weapons/w_glck18cdaclt.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(0.239, 0.642, 0.488), angle = Angle(-3.707, -5.283, 180), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
